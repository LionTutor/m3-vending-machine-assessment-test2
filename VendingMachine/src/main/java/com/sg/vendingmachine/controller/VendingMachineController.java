...
public class VendingMachineController {
        ...
        while (keepGoing) {
           ...
           /* switch (menuSelection) {
            ...
            if(menuSelection==0){
               ...
               BigDecimal money=BigDecimal.valueOf(io.readDouble("Please insert money: "));               
               
               processOrder(money, menuSelection);
            }
    ...
    private void processOrder(BigDecimal money, int menuSelection) throws VendingMachineDaoException {
        ...
        if(subtract.compareTo(BigDecimal.ZERO) < 0){
          io.print("The money you gave " +money+ " is insufficient.");
            ...
            io.print(moneyChange.QUARTERS+"(25Cents): ");
            io.print(moneyChange.DIMES+"(10Cents): ");
            io.print(moneyChange.NICKELS+"(5Cents): ");
            io.print(moneyChange.PENNIES+"(1Cent): ");
        }
    }
